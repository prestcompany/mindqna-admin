  ...
  return (
    <div className='space-y-6'>
      ...
      <section>
        ...
        <div className='grid grid-cols-1 gap-x-6 gap-y-6 rounded-lg border border-slate-200 bg-white p-6 sm:grid-cols-2 xl:grid-cols-3'>
        ...
        {detail.profiles?.length ? (
          <div className='space-y-2'>
            {detail.profiles.map((profile) => {
              ...
              return (
                <div key={profile.id} className='flex items-start gap-3 rounded-lg border border-slate-200 bg-white px-3 py-2.5'>
          ...
          <div className='rounded-lg border border-slate-200 bg-white px-4 py-6 text-center text-sm text-slate-500'>멤버 정보가 없습니다.</div>
        )}
      </section>
      ...
      <section>
        ...
        {detail.recentCoinMetas?.length ? (
          <div className='max-h-[420px] divide-y divide-slate-100 overflow-y-auto rounded-lg border border-slate-200 bg-white px-4'>
          ...
          <div className='rounded-lg border border-slate-200 bg-white px-4 py-6 text-center text-sm text-slate-500'>최근 재화 이용 내역이 없습니다.</div>
        )}
      </section>
    </div>
  );
