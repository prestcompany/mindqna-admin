  ...
  return (
    ...
    >
      {items.map((card) => {
        ...
        return (
          <div key={card.id} className='overflow-hidden rounded-lg border border-border bg-white'>
            <button
              type='button'
            ...
            >
              <div className='min-w-0'>
                ...
                <div className='text-xs text-muted-foreground'>{dayjs(card.createdAt).format('YY.MM.DD HH:mm')}</div>
              </div>
