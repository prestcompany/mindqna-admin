 ...
 * panel, confirm the resolution, send. The field stays editable, because this is a starting
 * point rather than a restriction.
 *
 * One address is not one person. Each of these fronts a SocialAccount, and several carry
 * more than one. A teammate signed in with Google on one phone and Kakao on another is two
