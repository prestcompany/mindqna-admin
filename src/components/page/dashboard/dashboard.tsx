...
import DashboardCoreStats from './sections/dashboard-core-stats';
...
import DashboardFilterBar from './sections/dashboard-filter-bar';
import DashboardGrowthSkeleton from './sections/dashboard-growth-skeleton';
    ...
    <div className='relative flex min-h-screen w-full flex-col gap-6 bg-white pb-8'>
      ...
      <section className='space-y-4'>
        ...
        <Tabs value={activeTab} className='space-y-4' onValueChange={handleTabChange}>
          <TabsList className='w-fit rounded-2xl border border-border bg-white p-1'>
