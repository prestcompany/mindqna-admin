...
const CustomFormModal: React.FC<CustomFormProps> = ({ init, reload, close }) => {
  const [isLoading, setLoading] = useState(false);
  // A step inside this same modal, not a second overlay on top of it — picking swaps the
  // modal's body for the grid, and the form's own state isn't touched by the swap.
